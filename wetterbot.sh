...
animate_clouds() {
  local frames=(
"${WHITE}        .--.    .--.  \n     .-(    ).(    )-. \n    (___.__)(___.__)__${RESET}"
"${WHITE}    .--.        .--.   \n  .-(    ).  .-(    ). \n (___.__)__(___.__)___${RESET}"
"${WHITE} .--.             .--. \n-(    )-.     .-(    )-\n(___.__)__   (___.__)__${RESET}"
"${WHITE}        .--.    .--.   \n     .-(    ).(    )-. \n    (___.__)(___.__)__${RESET}"
  )
  for i in {1..12}; do
    clear
...
show_animation() {
  ...
  local weather_lower="$(echo "$weather_condition" | tr '[:upper:]' '[:lower:]')"
  if [[ "$weather_lower" == *"rain"* ]]; then
    animate_rain
  elif [[ "$weather_lower" == *"snow"* ]]; then
    animate_snow
  elif [[ "$weather_lower" == *"cloud"* ]]; then
    animate_clouds
  elif [[ "$weather_lower" == *"clear"* ]]; then
    animate_sun
  fi
}
